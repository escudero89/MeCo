...
function [ phi ] = conduccion_calor_corona_pizarron(
        ...
        # nodo de borde no esquina
            ...
            elseif(es_interior(i) == 13) # Borde: r=r2,tita
                ...
                if (cond_contorno(3))
                    ...
                    K(i, coord2vec(l, m, ir_dir_tita, cant_nodo_en_dir) ) = 2*delta*h + 3*k(l,m);
                    K(i, coord2vec(l-1, m, ir_dir_tita, cant_nodo_en_dir) ) = -4 * k(l,m);
                    K(i, coord2vec(l-2, m, ir_dir_tita, cant_nodo_en_dir) ) = k(l,m);
